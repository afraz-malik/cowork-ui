        ...
        <div className='settingPage'>
          ...
          <div className='settingCustom'>
            <div className='dashboardInfos'>
              ...
              <div>
                <p>Assets (Admin)</p>
                <span>Manage bookable spaces</span>
              </div>
            </div>
            <div className='authToggle'>
              {authValue === true ? (
          ...
          <div className='settingCustom'>
            <div className='dashboardInfos'>
              ...
              <div>
                <p>Finances (Admin)</p>
                <span>Invoices, income, expense tracking, etc</span>
              </div>
            </div>
            <div className='authToggle'>
              {authValue === true ? (
