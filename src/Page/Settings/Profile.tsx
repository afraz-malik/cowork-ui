  ...
  return (
    <>
          ...
          <div className='companyName'>
            ...
            <div className='rightFileSetting col-8'>
              <div className='logoImageBox liteIcon'>
                {lightLogoFile && lightLogoFile.length > 0 ? (
                  <img
                    src={lightLogoFile}
          ...
          <div className='companyName'>
            ...
            <div className='rightFileSetting col-8'>
              <div className='logoImageBox darkIcon'>
                {darkLogoFile && darkLogoFile.length > 0 ? (
                  <img
                    src={darkLogoFile}
                    className='changeLogo'
                    alt='change-logo'
          ...
          <div className='companyName'>
            ...
            <div className='rightFileSetting col-8'>
              <div className='iconImageBox liteIcon'>
                {lightIconFile && lightIconFile.length > 0 ? (
                  <img
                    src={lightIconFile}
                    className='changeLogo'
                    alt='change-logo'
          ...
          <div className='companyName'>
            ...
            <div className='rightFileSetting col-8'>
              <div className='iconImageBox darkIcon'>
                {darkIconFile && darkIconFile.length > 0 ? (
                  <img
                    src={darkIconFile}
                    className='changeLogo'
                    alt='change-logo'
      ...
      <ConfirmationModal
        ...
        afterConfirmationApi={editProfile}
