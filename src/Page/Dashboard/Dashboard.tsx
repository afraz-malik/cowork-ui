...
const Dashboard = () => {
  ...
  const series = [
    {
      name: 'series-1',
      data: [2, 10, 15, 20, 26, 30, 34, 38, 40, 42, 45, 47, 50, 35, 49, 55, 60, 62, 67, 70, 80, 75, 70, 65, 72, 85, 91, 125],
    },
  ];
              ...
              <Col md={8}>
                <div className="incomeGraph">
                  ...
                  <div className="graphChart">
                    <Chart options={options} series={series} type="area" height="270px" />
                  </div>
                </div>
              </Col>
              <Col md={4}>
                <div className="monthIncome">
                  ...
                  <div className="circleChart">
                    <Chart options={pieOptions} series={pieSeries} type="donut" width="160px" height="160px" />
                  </div>
                  ...
                  <Table responsive hover>
                    <thead>
                      <tr>
                        ...
                        <th>Desk Type</th>
                        <th>Income <FontAwesomeIcon icon={faArrowUp} /></th>
                        <th>Status</th>
                      </tr>
                    </thead>
                    <tbody>
