        ...
        <div className='contacts'>
          <div className='all-messages-parent'>
            ...
            <div className='button'>
              <img className='info-circle-icon' alt='' src='/plus.svg' />
            </div>
          </div>
          ...
          <div className='contact'>
              ...
              <div className='avatar-parent'>
                ...
                <div className='text'>
                  ...
                  <div className='hi-how-are'>
                    Hi! How are things with the ill...
                  </div>
                </div>
              </div>
            ...
            <div className='contact2'>
              <div className='avatar-parent'>
                ...
                <div className='text'>
                  <div className='buzz-coworking'>Zoe Harper</div>
                  <div className='hi-how-are'>
                    Good morning! Absolutely, I...
                  </div>
                </div>
              </div>
              <div className='parent'>
            ...
            <div className='contact1'>
              <div className='avatar-parent'>
                ...
                <div className='text'>
                  <div className='buzz-coworking'>Liam Parker</div>
                  <div className='hi-how-are'>
                    Hi! How are things with the ill...
                  </div>
                </div>
                ...
                <div className='input-with-label'>
                  ...
                  <div className='input'>
                    ...
                    <div className='content3'>
                      <div className='text9'>Send a message...</div>
                    </div>
                    <img
