      ...
      {props.mode === CHAT_TEXT ? (
          ...
          <div className='message w-100'>
            ...
            <div className='message1'>
              <div className='hihow-are-things-with-our-ill-wrapper'>
                <div className='hihow-are-things'>{props.message}</div>
              </div>
              <div className='wrapper3'>
                <div className='div16'>
                  {convertTimeToReadable(props.created_at)}
                </div>
              </div>
            </div>
          </div>
        ...
        <div className='div24'>
          <div className='message1'>
            <a
              className='message6'
              download={props.file_path}
              href={`${process.env.REACT_APP_DOCOTEAM_API_URL}/${props.file_path}`}
            >
              <img
                className='mask-group-icon'
                alt=''
                src={
                  isImage(props.file_path)
                    ? `${process.env.REACT_APP_DOCOTEAM_API_URL}/${props.file_path}`
                    : nofilePath
                }
              />
            </a>
