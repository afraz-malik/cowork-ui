            ...
            <div className="u2div">
              <div className="u2div-2 avatar">
                {to.map((e: USER, i: number) =>
                  <>{e.avatar ? <img loading="lazy" className="u2img avatar-icon1" alt="" src={`${API}/${e.avatar}`} />
                  : <img loading="lazy" className="u2img avatar-icon1" alt="" src={avatar} />
              }</>
                )}
              </div>
              <div className="u2div-3">
                {to.map((e: USER, i: number) =>
                  <label>{e.name}{i + 1 !== to.length ? ", " : ""}</label>
                )}
              </div>
