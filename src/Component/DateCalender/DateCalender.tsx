...
const DateCalender = ({ dueDate, setDueDate, dueDateChange }: DateProps) => {
    ...
    return (
        <>
            <DatePicker selected={dueDate} placeholderText="Select a date" onChange={dueDateChange} dateFormat="MM/dd/yyyy" customInput={<CustomDatePickerInput />} renderCustomHeader={CustomHeader} />
        </>
    )
}
