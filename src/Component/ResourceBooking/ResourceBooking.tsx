...
const CardPaymentOption = ({authValue, setPaymentShow, selectedDate, startTime, endTime, resourceDetail, tabChoose, resourceBooked }: tabPaymentProps) => {
    ...
    const amountValue = findTimeGap(startTime, endTime) * parseInt(resourceDetail.member_rate)
                ...
                {payView ? "" :
                    <><form onSubmit={handleSubmit} className="DemoWrapper">
                        ...
                        <div className="resourcesBtn">
                            ...
                            <button type='submit' className='continue'>Continue <FontAwesomeIcon icon={faArrowRight} /></button>
                        </div>
                    </form>
                    </>
                }
                                                ...
                                                <div className='resourcePay'>
                                                    ...
                                                    {instantPay ? <>
                                                        <div className="resourcePrice">
                                                            <div>
                                                                <p>Duration: {startTime ? findTimeGap(startTime, endTime) : ""} {resourceDetails.member_time}</p>
                                                                <p>${resourceDetails.member_rate}</p>
                                                            </div>
                                                            <div>
                                                                <p>Total</p>
                                                                <p>${(startTime ? findTimeGap(startTime, endTime) : 0) * parseInt(resourceDetails.member_rate)}</p>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div className="resourcePayment">
                                                            <div className="cardPayment">
                                                                <Elements stripe={stripePromise}>
                                                                    <CardPaymentOption authValue={authValue} setPaymentShow={setPaymentShow} selectedDate={selectedDate} startTime={startTime} endTime={endTime} resourceDetail={resourceDetails} resourceBooked={resourceBooked} tabChoose={tabChoose} />
                                                                </Elements>
                                                            </div>
                                                        </div>}
