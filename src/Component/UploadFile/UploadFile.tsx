...
const UploadFile = ({
  ...
  const onFileDrop = (event: any) => {
    ...
    if (imageFile && imageFile.size <= 26 * 1024 * 1024) {
      // Convert MB to bytes
      setFile(imageFile)
            ...
            <Col md={12}>
                ...
                <div className='adminOption'>
                  {userImage && userImage ? (
                    <img
                      src={`${API}/${userImage}`}
                      className={
                        userRole === 'admin' ? 'adminBorder' : 'adminBorderless'
                      }
                      alt='admin'
                    />
                  ) : (
                ...
                <div className='shareMember'>
                  ...
                  <div>
                    <ul className='searchMemberList'>
                      {filteredSharesList &&
                        filteredSharesList.map((member: any, index) => (
                          <li
                            key={`member` + index}
              ...
              <div className='uploadBtn'>
                {uploadedFiles && uploadedFiles.length === 0 ? (
                  ...
                  <button className='btn save' type='submit' onClick={addFiles}>
                    Save
                  </button>
                )}
              </div>
